...
<html>
<head>
    <title>Insert Passenger Details - SP Airlines</title>
...
<body id="top">
    ...
    <section id="one" class="wrapper style1">
    	<header class="major">
         	<h2>Please Enter Passenger Details</h2>
     	</header>
        <div class="container">
            <div class="row">
                <div class="12u">
                 <% 
                    ...
                    <form action="InsertPassengerDetailsServlet" method="POST">
                        ...
                        Passport Number* <input type="text" name="passportNo<%=i%>" required/>
                        Passenger Type* <select name="passengerType<%=i%>">
                      		<option>Adult</option>
                      		<option>Child</option>
                      	</select> <br>
                      	<% } 
                        ...
                        Title* <select name="contactTitle">
                      		<option>Mr</option>
                      		<option>Mrs</option>
                      		<option>Miss</option>
                      		<option>Mdm</option>
                        ...
                        Name* <input type="text" name="contactName" required/> 
                     	Email* <input type="email" name="contactEmail" placeholder="sample@example.com" required/>
                        Contact Number* <input type="text" name="contactNo" required />
                       <input type="submit" value="Proceed" class="bookFlight" />
                    </form>
                    <form action="clearBooking.jsp" method = "POST">
                    	<input type="submit" value="Delete Booking" class="bookFlight2" />
                    </form>
                    <%
         			}
         			
         			
         			String reEnter = request.getParameter("back");
         			if (reEnter!= null && reEnter.equals("insertPaymentDetailsjsp")) {
           				int totalnoofPassengers = (int)session.getAttribute("totalnoofPassengers");
                 		for (int i=0; i<totalnoofPassengers; i++) { %>
                    <form action="InsertPassengerDetailsServlet" method="POST">
                        <h3>Passenger <%=i+1%> Details</h3>
